...
class STRIPS(SearchDomain):
    ...
    # constructor
    def __init__(self, constrain=lambda  s, a: False):
    ...
    def result(self, state, action):
        if self.constrain(state, action):
            return None
        # verificar as pre-condiçoes
    ...
    def satisfies(self, state, goal):
        # verifica se todos os predicados de goal estao contidos no state
